...
function ToolBtn({ icon, label, active, onPress }: { icon: keyof typeof Ionicons.glyphMap; label: string; active: boolean; onPress: () => void }) {
  return (
    <TouchableOpacity style={[S.toolBtn, active && S.toolBtnOn]} onPress={onPress} activeOpacity={0.75}>
      <Ionicons name={icon} size={26} color={active ? T.indigo : T.mid} />
...
const S = StyleSheet.create({
  ...
  header:        { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingLeft: 22, paddingRight: 22, paddingTop: 60, paddingBottom: 5, gap: 12, backgroundColor: T.paper, zIndex: 10 },
  backBtn:       {
  ...
  pdfScreen:     { flex: 1 },
  toolbar:       { flexDirection: 'row', backgroundColor: T.paper, paddingTop: 8, paddingBottom: 12, paddingHorizontal: 40, gap: 28, zIndex: 10 },
  toolBtn:       { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 7, paddingHorizontal: 3, borderRadius: 18, backgroundColor: T.surface, borderWidth: 1, borderColor: T.line, gap: 3 },
