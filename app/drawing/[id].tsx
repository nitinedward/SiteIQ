...
const S = StyleSheet.create({
  ...
  toolBtn:       { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 14, paddingHorizontal: 8, borderRadius: 16, backgroundColor: T.surface, borderWidth: 1, borderColor: T.line, gap: 5 },
